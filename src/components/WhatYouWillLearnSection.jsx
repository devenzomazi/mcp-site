...
const items = [
  {
    ...
    description: "Utilizando apenas seu celular (fotos, vídeos, Reels e Stories);",
  },
  {
    img: cardFinanceiro,
    alt: "Aprender a cobrar do seu cliente",
    description: "Saber precificar, montar contratos e atender clientes com segurança.",
  },
  {
    img: cardVerificado,
    ...
    <section className="bg-white px-4 py-16">
      <div className="mx-auto max-w-screen-2xl">
        ...
        <header className="mb-12 flex items-center justify-center gap-3 text-center">
          ...
          <h2 className="text-3xl font-semibold leading-snug text-black lg:text-5xl">
        ...
        <div className="grid gap-10 lg:grid-cols-3 justify-items-center">
          {items.map((item) => (
            <article key={item.alt} className="flex flex-col items-center">
              {/* CONTAINER DO CARD */}
              <div className="w-[484px] flex flex-col items-center">
                {/* IMAGEM */}
                <img
                  src={item.img}
                  alt={item.alt}
                ...
                {/* BLOCO DE TEXTO / LINHA MAIS ESTREITA PARA FICAR SIMÉTRICO */}
